...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = res.message || 'Registration successful! Please check your email to verify your account.'
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#442D1C] p-8 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] border border-white/10 slide-in-up relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold mb-3 text-white font-outfit">Create Account</h2>
          <p className="text-orange-100/70 text-lg font-light">Join our club membership system</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="group">
            <label className="block text-xs font-semibold text-orange-200/80 mb-2 uppercase tracking-widest pl-1">Full Name</label>
          ...
          <div className="group">
            <label className="block text-xs font-semibold text-orange-200/80 mb-2 uppercase tracking-widest pl-1">Email</label>
            <div className="relative">
              <input
                value={email}
          ...
          <div className="group">
            ...
            <p className="text-xs text-orange-200/50 mt-2 pl-1">
              Must be at least 8 characters with 1 special character (e.g., !@#$)
            </p>
          </div>
